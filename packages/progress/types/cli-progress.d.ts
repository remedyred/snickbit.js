/* eslint-disable unicorn/prefer-event-target,max-len */
...
export interface Options {
	 ...
	 */
	format?: GenericFormatter | string | undefined
...
export type ValueType = 'duration' | 'eta' | 'percentage' | 'total' | 'value'
